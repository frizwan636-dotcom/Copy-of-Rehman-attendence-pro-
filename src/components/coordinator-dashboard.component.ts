              ...
              <div class="bg-white p-6 rounded-[2.5rem] shadow-sm border space-y-4">
                ...
                <div class="flex gap-4">
                  ...
                  <div class="flex-1 grid grid-cols-2 gap-3">
                    ...
                    <input type="email" [ngModel]="newTeacherEmail()" (ngModelChange)="newTeacherEmail.set($event)" placeholder="Email Address" class="col-span-2 p-3 bg-slate-50 rounded-xl border outline-none text-sm">
